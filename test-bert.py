...
def get_doc_test(qrel_path,refs):
...
def calculate_embeddings(tokenizer, model, result_path, refs,paper_inputs,paper_ids):
...
def main():
    ...
    if args.test_only:
        ...
        #python test-bert.py --save_dir save-scidocs --gpus 1 --test_only $true --test_checkpoint save-bert-complete/version_0/checkpoints/ep-epoch=0_avg_val_loss-avg_val_loss=0.434.ckpt
        ...
        qrel_file="corpus/test.qrel"
        paper_ids,paper_inputs=get_doc_test(qrel_file,refs)



        calculate_embeddings(model.tokenizer,model,"corpus/bert-embeddings.jsonl",refs,paper_inputs,paper_ids)
